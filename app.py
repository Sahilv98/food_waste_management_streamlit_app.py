...
# 2. Define the path for the 'database' directory
DB_DIR = os.path.join(BASE_DIR, "database")

# 3. CRITICAL: Create the 'database' directory if it didn't get pushed to GitHub
os.makedirs(DB_DIR, exist_ok=True)

# 4. Build the final absolute path to the database file
db_path = os.path.join(DB_DIR, "food_waste.db")

# 5. Connect securely using the absolute path
